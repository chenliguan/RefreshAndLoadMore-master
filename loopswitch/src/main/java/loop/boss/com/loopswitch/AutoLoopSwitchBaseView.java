...
//        windowManager.getDefaultDisplay().getMetrics(displayMetrics);
        //动态设置子控件居中,第二参数高度是指圆点顶-底的高
//        LayoutParams params = generalLayoutParams(LayoutParams.MATCH_PARENT,
...
//
    ...
    protected void refreshIndicateView(int currentIndex, int datacount) {
        if (datacount > 1) {
            for (int index = 0; index < datacount; index++) {
                final ImageView imageView = (ImageView) indicateLayout.getChildAt(index);
                //圆点间隔
